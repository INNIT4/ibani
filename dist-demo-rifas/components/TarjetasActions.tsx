  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 mt-5 justify-center">
      <button
        ...
        disabled={waLoading}
        className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-500 hover:bg-green-600 disabled:opacity-50 text-white font-bold rounded-xl transition-colors"
      >
        {waLoading ? (
      ...
      <button
        onClick={handlePDF}
        disabled={pdfLoading}
        className="inline-flex items-center justify-center gap-2 px-6 py-3 border-2 border-red-500 text-red-600 dark:text-red-400 font-bold rounded-xl hover:bg-red-50 dark:hover:bg-red-900/30 disabled:opacity-50 transition-colors"
      >
        {pdfLoading ? (
        ...
        {pdfLoading ? "Generando..." : "Descargar comprobante PDF"}
      </button>
    </div>
  );
}
